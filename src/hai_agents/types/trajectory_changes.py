...
class TrajectoryChanges(UniversalBaseModel):
    """
    ...
    new_events: typing.Optional[typing.List[TrajectoryEvent]] = None
    answer: typing.Optional[TrajectoryChangesAnswer] = None
