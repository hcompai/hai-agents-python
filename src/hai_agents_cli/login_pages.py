...
Two near-identical pages (success / error) sharing one CSS shell. Strings live
here as plain constants, no template engine, no package data: stdlib only.
"""
...
ERROR_HTML = _page(
    ...
    subtitle="Return to your terminal for details, then run hai login again.",
    icon=_ICON_X,
)
